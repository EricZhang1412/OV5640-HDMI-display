...
int main(void)
{
	...
	i2c_init(&ps_i2c0, XPAR_XIICPS_1_DEVICE_ID,40000);
	...
	/* Start Sensor Vdma */
	while(1) {
		vdma_write_init(XPAR_AXIVDMA_1_DEVICE_ID,1920 * 3,1080,1920 * 3,(unsigned int)dispCtrl.framePtr[dispCtrl.curFrame]);
		usleep(3000000);
	}
